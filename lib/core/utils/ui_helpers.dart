...
class UIHelpers {
  ...
  // Text styles
  static TextStyle? get headline1 => const TextStyle(fontSize: 32, fontWeight: FontWeight.bold);
  static TextStyle? get headline2 => const TextStyle(fontSize: 28, fontWeight: FontWeight.w600);
  static TextStyle? get headline3 => const TextStyle(fontSize: 24, fontWeight: FontWeight.w600);
  static TextStyle? get headline4 => const TextStyle(fontSize: 20, fontWeight: FontWeight.w600);
